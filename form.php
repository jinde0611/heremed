...
?>
  ...
  <!-- Modal Structure -->
  <div class = "overlay" style="background: rgba(0,0,0,.58);position: fixed;width: 100%;height: 100%;z-index: 1;display:none;"></div>
...
<div   class="row pinfo_hide" style="margin-top:-10%;">
  <div class="col s12 m5 l8 offset-l2">
      <div class="card-panel ">
        ...
        {?>
          <span class="" style="padding:20px;border:2px solid black; border-radius: 10px;margin-right:20px;"></span>
        <?php }
        ?>
        <!-- Modal Trigger -->
        <br><br><br>
